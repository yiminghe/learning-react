...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Line = __webpack_require__(353);
	
	var _Line2 = _interopRequireDefault(_Line);
	
	var _StrikeDash = __webpack_require__(355);
	
	var _StrikeDash2 = _interopRequireDefault(_StrikeDash);
	
	var _ClipPath = __webpack_require__(356);
	...
	var Line = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.state.pos > 0.99) {
	      end = _react2.default.createElement('circle', {
	        cx: this.props.end.x,
	        cy: this.props.end.y,
	        r: '10',
	        stroke: 'black',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StrikeDash = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.state.end) {
	      endCircle = _react2.default.createElement('circle', {
	        cx: endX,
	        cy: endY,
	        r: '10',
	        stroke: 'black',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClipPath = _react2.default.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    ...
	    style.transition = style.MsTransition = style.msTransition = style.WebkitTransition = 'none';
	    // Set up the starting positions
	    style.WebkitClipPath = 'polygon(' + startX + 'px ' + startY + 'px,' + startX + 'px ' + startY + 'px,\n      ' + startX + 'px ' + startY + 'px,' + startX + 'px ' + startY + 'px)';
	    return {
	      style: style,
	      path: path
	    };
