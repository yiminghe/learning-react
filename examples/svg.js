...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2['default'].render(_react2['default'].createElement(
	  'div',
	  null,
	  _react2['default'].createElement(_ClipPath2['default'], { start: { x: 200, y: 200 }, end: { x: 300, y: 300 }, duration: 2 }),
	  _react2['default'].createElement(_Line2['default'], { start: { x: 20, y: 20 }, end: { x: 300, y: 300 }, duration: 2 }),
	  _react2['default'].createElement(_StrikeDash2['default'], { start: { x: 200, y: 200 }, end: { x: 300, y: 300 }, duration: 2 })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Line = _react2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    self.anim = (0, _jquery2['default'])(current);
	    self.anim.animate({
	      x: end.x,
	      y: end.y
	    }, {
	  ...
	  render: function render() {
	    ...
	    if (this.state.pos > 0.99) {
	      end = _react2['default'].createElement('circle', { cx: this.props.end.x, cy: this.props.end.y, r: '10', stroke: 'black',
	    ...
	    return _react2['default'].createElement(
	      'div',
	      null,
	      _react2['default'].createElement('h2', { dangerouslySetInnerHTML: { __html: x } }),
	      _react2['default'].createElement(
	        'svg',
	        { width: '400', height: '400' },
	        _react2['default'].createElement('circle', { cx: this.props.start.x, cy: this.props.start.y, r: '10', stroke: 'black',
	          strokeWidth: '5', fill: 'red' }),
	        end,
	        _react2['default'].createElement('path', { d: this.state.path,
	          stroke: 'red',
	          strokeWidth: '2'
	        })
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StrikeDash = _react2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    var style = this.refs.path.style;
	  ...
	  render: function render() {
	    ...
	    if (this.state.end) {
	      endCircle = _react2['default'].createElement('circle', { cx: endX, cy: endY, r: '10', stroke: 'black',
	        strokeWidth: '5', fill: 'red' });
	    ...
	    return _react2['default'].createElement(
	      'div',
	      null,
	      _react2['default'].createElement('h2', { dangerouslySetInnerHTML: { __html: h2Title } }),
	      _react2['default'].createElement(
	        'svg',
	        { width: '400', height: '400' },
	        _react2['default'].createElement('circle', { cx: startX, cy: startY, r: '10', stroke: 'black',
	          strokeWidth: '5', fill: 'red' }),
	        endCircle,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClipPath = _react2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    setTimeout(function () {
	      var style = (0, _objectAssign2['default'])({}, _this.state.style);
	      // Define our transition
	      // ie11 not working...
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'svg',
	        { width: '400', height: '400', style: this.state.style },
	        _react2['default'].createElement('rect', { width: '400', height: '400', fill: 'white' }),
	        _react2['default'].createElement('circle', { cx: this.props.start.x, cy: this.props.start.y, r: '10', stroke: 'black',
	          strokeWidth: '5', fill: 'red' }),
	        _react2['default'].createElement('circle', { cx: this.props.end.x, cy: this.props.end.y, r: '10', stroke: 'black',
	          strokeWidth: '5', fill: 'red' }),
	        _react2['default'].createElement('path', { d: this.state.path,
	          stroke: 'red',
	          strokeWidth: '2'
